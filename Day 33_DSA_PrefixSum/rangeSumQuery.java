...
public class rangeSumQuery {
    public long[] rangeSum(int[] A, int[][] B) {
        ...
        // int q = B.length; // No. of rows of queries array B
        // long[] pfSum = new long[n]; // prefix Sum array declaration
        // long[] ans = new long[q];
        // pfSum[0] = A[0];

        // //Initializing prefix Sum array pfSum
        // for(int i=1;i < n;i++) {
        // pfSum[i] = pfSum[i-1] + A[i];
        // }

        // //Adding ranges sum to an array ans
        // for(int i=0;i < q;i++) {
        // int L = B[i][0];
        // int R = B[i][1];
        // if(L == 0) {
